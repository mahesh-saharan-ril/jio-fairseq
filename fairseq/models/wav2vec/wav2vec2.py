...
class Wav2Vec2Model(BaseFairseqModel):
    ...
    def forward(
        ...
        x, z = self.encoder(x, padding_mask=padding_mask)
...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, x, padding_mask=None, need_weights = False):
        x = self.extract_features(x, padding_mask, need_weights)
    ...
    def extract_features(self, x, padding_mask=None, need_weights=False):
        ...
        for i, layer in enumerate(self.layers):
            ...
            if not self.training or (dropout_probability > self.layerdrop):
                x, z = layer(x, self_attn_padding_mask=padding_mask, need_weights=need_weights)
                layer_results.append(x)
                layer_attentions.append(z)
    ...
    def add_pos_end(self, x, padding_mask=None):
    ...
    def transformer_layers(self, x, padding_mask=None, need_weights=False):
